package com.avtelma.tagaevplanner.ui.screens.addsphere
...
@Composable
fun AddSpheresScreen(navController: NavHostController, mainViewModel: MainViewModel) {
    ...
    Column(
        ...
        OutlinedButton(modifier = Modifier.fillMaxWidth().height(150.dp)
            ...
            onClick = {
                ...
                mainViewModel.addSphere(Sphere(textState.value,"${System.currentTimeMillis()/1000L}"))
            }
        ) {
